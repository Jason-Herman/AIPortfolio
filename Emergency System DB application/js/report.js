function displayResources(data){
    ...
    sHTML += '<h4 class="col-md-2">Description</h4>';
    sHTML += '<h4 class="col-md-2">Total Resources</h4>';
    sHTML += '<h4 class="col-md-2">In Use</h4>';
    sHTML += '</div>';

    //records report
    sHTML += '<div class="reportWrapper">';
    ...
    if(data.length==0){
        ...
        data.forEach(function (item, index) {
            ...
            sHTML += '<div class="col-md-2 resultCell">' + item.Total_Resources + '</div>';
            sHTML += '<div class="col-md-2 resultCell">' + item.In_Use + '</div>';
