...
class Board:
    ...
    def __init__(self, player_1, player_2, width=7, height=7):
        ...
        self.queen_11 = "queen11" #player 1
        self.queen_12 = "queen12"
        self.queen_21 = "queen21" #player 2
        self.queen_22 = "queen22"
        
        self.__board_state__ = [ [Board.BLANK for i in range(0, width)] for j in range(0, height)]
        self.__last_queen_move__ = {self.queen_11:Board.NOT_MOVED, self.queen_12:Board.NOT_MOVED, self.queen_21:Board.NOT_MOVED, self.queen_22:Board.NOT_MOVED} #Gets updated
        self.__queen_symbols__ = {Board.BLANK: Board.BLANK, self.queen_11:11, self.queen_12:12, self.queen_21:21, self.queen_22:22}     #makes it an integer - not sure what that means
        ...
        self.__active_player__ = player_1 #Have to set the active player before a move
    ...
    def __apply_move_write__(self, move, __active_queen__): #used for printing of board states
        row,col = move
    ...
    def forecast_move(self, move, queen):    #for if you want to predict what a board would look like if you made a move
        new_board = self.copy()
    ...
    def get_opponent_moves(self):   #Need to look into what this does exactly
    ...
    def get_legal_moves(self): #Really useful for open eval function. Probably what you want to use
